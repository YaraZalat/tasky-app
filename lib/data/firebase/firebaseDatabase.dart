...
import 'package:ttttttt/data/model/user_model.dart';

abstract class FirebaseDatabase{
  static CollectionReference<UserModel> colleectionUser(){
  ...
  static Future<void> createUser(UserModel user)async{
    return colleectionUser().doc(user.id).set(user);
  }
  static Future<UserModel?> getUser(String userId)async{
    var data = await colleectionUser().doc(userId).get();
    return data.data();
  }
